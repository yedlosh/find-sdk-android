...
//    }
    ...
    private void drawUi() {
        ...
        trackInterval.setText(String.valueOf(userSettings.getTrackScanIntervalInSeconds()));

        learnInterval.setText(String.valueOf(userSettings.getLearnScanIntervalInSeconds()));
